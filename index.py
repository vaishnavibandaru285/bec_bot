...
async def placements_button_callback(update, context) -> None:
    ...
    await query.message.reply_photo(open('bardetails.jpg','rb'))
    await query.message.reply_photo(open('barg.png','rb'))
    await query.message.reply_photo(open('2020-21pie.jpg','rb'))
    await query.message.reply_photo(open('2021-22pie.jpg','rb'))
    await query.message.reply_photo(open('2022-23pie.jpg','rb'))                                                                                                                               
